...
$info = infohelper::Getinfobydatemonth($date_month,$date_year);
?>
<section>
        <div class="container text-center">
        <ul class="nav nav-tabs allign-center">

  <li role="presentation" class="active" ><a href="#"><?php echo $date_year?>年<?php echo $date_month?>月</a></li>
</ul>
    <br>
<?php 
while($infoarray = mysql_fetch_object($info)){
	$id = $infoarray -> id;
